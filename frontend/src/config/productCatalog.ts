...
export const productCatalog: EduCodeProduct[] = [
  ...
  { code: 'connect', name: 'EduCode Connect', tagline: 'Comunicar e colaborar', description: 'Comunicação, fóruns e colaboração entre estudantes, educadores e instituições.', icon: '◉', capabilities: ['Comunicação', 'Fóruns', 'Colaboração'], routes: { student: '/aluno/atividades', educator: '/notificacoes', admin: '/notificacoes' } },
  { code: 'credentials', name: 'EduCode Credentials', tagline: 'Reconhecer conquistas', description: 'Portfólio, competências, produções, reflexões e certificações do estudante.', icon: '◆', capabilities: ['Portfólio', 'Competências', 'Certificados'], routes: { student: '/aluno/portfolio', educator: '/analytics', admin: '/analytics' } },
